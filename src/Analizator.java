...
class Result{
    ...
    public String ErrMessage(){
        switch(_Err) {
            ...
            case Err.SignedExceptions:
            { return "ожидается знак"; }
            case Err.SignedDigitExceptions:
            { return "ожидается знак или цифра"; }
            case Err.DigitExceptions:
            { return "ожидается цифра"; }
            case Err.DigitBracketExceptions:
            { return "ожидается цифра или ']'"; }
            case Err.LetterExceptions:
            { return "ожидается буква"; }
            case Err.LetterUnderExceptions:
            { return "ожидается буква или нижнее подчёркивание"; }
            case Err.LetterUnderDigitalExceptions:
            { return "ожидается буква, нижнее подчёркивание или цифра"; }
            case Err.LetterUnderSpaceRParenExceptions:
            { return "ожидается буква, нижние подчёркивание, отступ или ')'"; }
            case Err.LetterUnderSpaceRBracketExceptions:
            { return "ожидается буква, нижние подчёркивание, отступ или ']'"; }
            case Err.IndentDigitExceptions:
            { return "ожидается отступ или буква"; }
            case Err.TypeExceptions:
            { return "ожидается буква из зарезервированных слов: (int, float, set)"; }
            case Err.TypeIndentExceptions:
            { return "ожидается буква из зарезервированных слов: (int, float, set) или отступ"; }
            case Err.ControlExceptions:
            { return "ожидается буква из зарезервированного слова: return"; }
            case Err.ControlIndentExceptions:
            { return "ожидается буква из зарезервированного слова: return или отступ"; }
            case Err.RParenCommaExceptions:
            { return "')' или ','"; }
            case Err.IndentColonExceptions:
            { return "ожидается отступ или ':'"; }
            case Err.LParenExceptions:
            { return "ожидается '('"; }
            case Err.RParenExceptions:
            { return "ожидается ')'"; }
            case Err.ColonExceptions:
            { return "ожидается ':'"; }
            case Err.CommaExceptions:
            { return "ожидается ','"; }
            case Err.LBracketExceptions:
            { return "ожидается '['"; }
            case Err.RBracketExpected:
            { return "ожидается ']'"; }
            case Err.NewLineExceptions:
            { return "ожидается перенос строки"; }
            case Err.IndentExceptions:
            { return "ожидается отступ"; }
            case Err.AssignExceptions:
            { return "ожидается '='"; }
            case Err.AssignIndentExceptions:
            { return "ожидается '=' или отступ"; }
            case Err.IntLongExceptions:
            { return "число содержит больше 10 цифр"; }
            case Err.InvalidNumber:
            { return "? некорректное число"; }
            case Err.UnexpectedChar:
            { return "неожиданный символ"; }
            case Err.UnrecognizedError:
            { return "неизвестная ошибка"; }
            case Err.LetterDigitLParenIndentExceptions:
            { return "ожидается буква, цифра, нижнее подчёркивание или '('"; }
            case Err.LetterUnderRParenColonCommaExceptions:
            { return "ожидается буква, нижние подчёркивание, ')', ':' или ','"; }
            case Err.ColonRParenExceptions:
            { return "ожидается ':' или ')'"; }
            case Err.LetterDigitUnderLBracketAssign:
            { return "ожидается буква, цифра, нижнее подчёркивание, '[' или '='"; }
            case Err.LBracketAssignExceptions:
            { return "ожидается '[' или '='"; }
            case Err.LetterDigitUnderLBracketNewLine:
            { return "ожидается буква, цифра, нижнее подчёркивание, '[' или перенос строки"; }
            case Err.LBracketAssignNewLineSignedExceptions:
            { return "ожидается '[', '=', перенос строки или знак"; }
            case Err.LetterDigitSignedException:
            { return "ожидается буква, цифра или '-'"; }
            case Err.LetterDigitUnderRBracketExceptions:
            { return "ожидается буква, цифра, нижнее подчёркивание или ']'"; }
            case Err.LetterDigitUnderLBracketExceptions:
            { return "ожидается буква, цифра, нижнее подчёркивание или '['"; }
            case Err.SignedNewLineExceptions:
            { return "ожидается знак или перенос строки"; }
    ...
    static class CheckFunctionDef{
        private enum EnumState { //S84 отсутствует, потому что он и есть Final
                ...
                if (_Pos >= _Str.length()){
                    ...
                    switch (state){
                        ...
                        case EnumState.Start:
                            if (_Str.charAt(_Pos) == 'd'){
                                state = EnumState.S2;
                            }
                            else{
                                SetError(Err.LetterExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;

                        case EnumState.S2:
                            if (_Str.charAt(_Pos) == 'e'){
                                state = EnumState.S3;
                            }
                            else{
                                SetError(Err.LetterExceptions, _Pos);
                        ...
                        case EnumState.S4:
                            if (_Str.charAt(_Pos) == ' '){
                                ...
                                SetError(Err.IndentExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S5:
                            if (Character.isLetter(_Str.charAt(_Pos)) || (_Str.charAt(_Pos) == '_')){
                                ...
                                SetError(Err.LetterUnderExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S6:
                            if (Character.isLetterOrDigit(_Str.charAt(_Pos)) || (_Str.charAt(_Pos) == '_')){
                                ...
                                SetError(Err.LetterDigitLParenIndentExceptions,_Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S6b:
                            if (_Str.charAt(_Pos) == '('){
                                ...
                                SetError(Err.LParenExceptions,_Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S7:
                            if (_Str.charAt(_Pos) == ' '){
                                ...
                                SetError(Err.LetterUnderSpaceRParenExceptions,_Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S9:
                            if (Character.isLetterOrDigit(_Str.charAt(_Pos)) || (_Str.charAt(_Pos) == '_')){
                                ...
                                SetError(Err.LetterUnderRParenColonCommaExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S9b:
                            if (_Str.charAt(_Pos) == ':'){
                                ...
                                SetError(Err.ColonRParenExceptions,_Pos);
                                state = EnumState.Error;
                            }
                            break;

                        case EnumState.S10:
                            if(_Str.charAt(_Pos) == 's'){
                                state = EnumState.S19;
                            }
                            else if(_Str.charAt(_Pos) == 'i'){
                                state = EnumState.S11;
                            }
                            else if(_Str.charAt(_Pos) == 'f'){
                                state = EnumState.S14;
                            }
                            else if (_Str.charAt(_Pos) == ' '){
                                state = EnumState.S10;
                                ...
                                SetError(Err.TypeExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S21:
                            if (_Str.charAt(_Pos) == ' '){
                                ...
                                SetError(Err.RParenCommaExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;

                        case EnumState.S11:
                            if (_Str.charAt(_Pos) == 'n'){
                                state = EnumState.S12;
                            }
                            else{
                                SetError(Err.TypeExceptions, _Pos);
                        ...
                        case EnumState.S22: // Много ожидаемых ошибок может быть, заменено на UnrecognizedError
                            if(Character.isLetter(_Str.charAt(_Pos)) || (_Str.charAt(_Pos) == '_')){
                                state = EnumState.S9;
                            }
                            else if (_Str.charAt(_Pos) == ' '){
                                ...
                                SetError(Err.UnrecognizedError, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S8:
                            if (_Str.charAt(_Pos) == ' '){
                                ...
                                SetError(Err.ColonExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S27, EnumState.S27b:
                            if (_Str.charAt(_Pos) == ' ') {
                                ...
                                SetError(Err.LetterDigitSignedException, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S62, EnumState.S62b:
                            if (_Str.charAt(_Pos) == ' ') {
                                state = EnumState.S62b;
                            }
                            else if (Character.isDigit(_Str.charAt(_Pos))) {
                                state = EnumState.S28;
                            }
                            else {
                                SetError(Err.DigitExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S64b:
                            if (_Str.charAt(_Pos) == ' ') {
                                ...
                                SetError(Err.RBracketExpected, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S28:
                            if (Character.isDigit(_Str.charAt(_Pos))) {
                                ...
                                SetError(Err.DigitBracketExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S29: // Много ожидаемых ошибок может быть, заменено на UnrecognizedError
                            if (_Str.charAt(_Pos) == '='){
                                state = EnumState.S30;
                            }
                            else if ((_Str.charAt(_Pos) == '+') || (_Str.charAt(_Pos) == '-') ||
                                    (_Str.charAt(_Pos) == '*') || (_Str.charAt(_Pos) == '/')) {
                                state = EnumState.S43;
                            }
                            else if (_Str.charAt(_Pos) == '\n') {
                                state = EnumState.S50;
                                ...
                                SetError(Err.SignedNewLineExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S31:
                            if ((Character.isLetterOrDigit(_Str.charAt(_Pos))|| (_Str.charAt(_Pos) == '_'))){
                                ...
                                SetError(Err.LetterDigitUnderLBracketNewLine, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S31b:
                            if (_Str.charAt(_Pos) == ' ') {
                                ...
                                SetError(Err.LBracketAssignNewLineSignedExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S63:
                            if (Character.isLetterOrDigit(_Str.charAt(_Pos)) || _Str.charAt(_Pos) == '_') {
                                ...
                                SetError(Err.LetterUnderSpaceRBracketExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S42:
                            if (_Str.charAt(_Pos) == ' ') {
                                ...
                                SetError(Err.SignedExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;

                        case EnumState.S60: // Табуляция: возможно IndentExceptions не подходит
                            if (_Str.charAt(_Pos) == '\t'){
                                state = EnumState.S51;
                            }
                            else{
                        ...
                        case EnumState.S46, EnumState.S48:
                            if (_Str.charAt(_Pos) == '='){
                                ...
                                SetError(Err.AssignIndentExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S44, EnumState.S45:
                            if (_Str.charAt(_Pos) == '='){
                                ...
                                SetError(Err.AssignExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S47: // Много ожидаемых ошибок может быть, заменено на UnrecognizedError
                            if ((Character.isLetter(_Str.charAt(_Pos))|| (_Str.charAt(_Pos) == '_'))){
                                state = EnumState.S31;
                            }
                            else if (_Str.charAt(_Pos) == ' '){
                        ...
                        case EnumState.S36: // Много ожидаемых ошибок может быть, заменено на UnrecognizedError
                            if ((Character.isDigit(_Str.charAt(_Pos)))){
                                state = EnumState.S36;
                            }
                            else if (_Str.charAt(_Pos) == '.'){
                            ...
                            else if ((_Str.charAt(_Pos) == 'e') || (_Str.charAt(_Pos) == 'E')){
                                state = EnumState.S39;
                            }
                            else if (_Str.charAt(_Pos) == ' '){
                                state = EnumState.S42;
                        ...
                        case EnumState.S38: // Много ожидаемых ошибок может быть, заменено на UnrecognizedError
                            if ((Character.isDigit(_Str.charAt(_Pos)))){
                                state = EnumState.S38;
                            }
                            else if ((_Str.charAt(_Pos) == 'e') || (_Str.charAt(_Pos) == 'E')){
                        ...
                        case EnumState.S39:
                            if ((_Str.charAt(_Pos) == '+') || (_Str.charAt(_Pos) == '-')){
                                ...
                                SetError(Err.SignedDigitExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S41: // Много ожидаемых ошибок может быть, заменено на UnrecognizedError
                            if ((Character.isDigit(_Str.charAt(_Pos)))){
                                state = EnumState.S41;
                            }
                            else if (_Str.charAt(_Pos) == ' '){
                        ...
                        case EnumState.S51:
                            ...
                            else if (_Str.charAt(_Pos) == 'r'){
                                state = EnumState.S52;
                            }
                            else{
                                SetError(Err.ControlIndentExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S52:
                            ...
                            else if (_Str.charAt(_Pos) == 'e'){
                                state = EnumState.S53;
                            }
                            else{
                                SetError(Err.ControlExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S57: // Добавить a|...|z|_|0|...|9 в 26???
                            if (_Str.charAt(_Pos) == ' '){
                                state = EnumState.S58;
                            }
                            else{
                        ...
                        case EnumState.S58: // Много ожидаемых ошибок может быть, заменено на UnrecognizedError
                            if ((Character.isLetterOrDigit(_Str.charAt(_Pos))|| (_Str.charAt(_Pos) == '_'))){
                                state = EnumState.S65;
                            }
                            else if (Character.isDigit(_Str.charAt(_Pos))){
                        ...
                        case EnumState.S65:
                            if ((Character.isLetterOrDigit(_Str.charAt(_Pos))|| (_Str.charAt(_Pos) == '_'))){
                                ...
                                SetError(Err.LetterDigitUnderLBracketExceptions, _Pos);
                                state = EnumState.Error;
                            }
                            break;
                        ...
                        case EnumState.S73: // Много ожидаемых ошибок может быть, заменено на UnrecognizedError
                            if ((Character.isDigit(_Str.charAt(_Pos)))){
                                state = EnumState.S73;
                            }
                            else if ((_Str.charAt(_Pos) == 'e') || (_Str.charAt(_Pos) == 'E')){
                        ...
                        case EnumState.S76: // Много ожидаемых ошибок может быть, заменено на UnrecognizedError
                            if ((Character.isDigit(_Str.charAt(_Pos)))){
                                state = EnumState.S76;
                            }
                            else if (_Str.charAt(_Pos) == ' '){
...
public class Analizator{
    public static void main(String[] args) {
        String test = "def get_state ( sym:int,data:set,fag):\n" +
